...
function sr_buy()
{
    ...
    if (from == 'company') {
      transfer_share(game.share_co[n], game.players[game.sr_current], share, n, game.actors[n].stock);
    } else {
...
function or_operate()
{
    ...
    $('#'+game.or_actor.name+'_run').html($('#or_run_value').val());
...
function sp_stock()
{
    ...
    transfer_share(game.actors[$('#sp_share_from').val()],
